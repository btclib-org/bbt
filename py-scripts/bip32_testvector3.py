...
"""Walk BIP32 test vector 3 through each derivation step.

Prints every intermediate value BIP32 defines, from the master extended private
key down to its one hardened child.
"""
