...
choices with non-obvious trade-offs, changes spanning many notebooks
or scripts with unclear dependencies, diagnosis where the symptom
does not point to the cause). Use `/model opus` for the session, then
